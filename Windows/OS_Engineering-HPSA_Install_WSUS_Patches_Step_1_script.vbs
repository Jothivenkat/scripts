'==========================================================================
'
' NAME: OS_Engineering-HPSA_Install_WSUS_Patches_Step_1_script.vbs
...
WScript.Echo "OS_Engineering-HPSA_Install_WSUS_Patches_Step_1_script"
...
Else
	...
	objShell.LogEvent EVENTLOG_SUCCESS, "OS_Engineering-HPSA_Install_WSUS_Patches_Step_1_script script has been started!" &_
	vblf & "SCRIPT NAME: OS_Engineering-HPSA_Install_WSUS_Patches_Step_1_script.vbs"
End If
...
If intShellFail <> 1 Then
	objShell.LogEvent EVENTLOG_SUCCESS, "OS_Engineering-HPSA_Install_WSUS_Patches_Step_1_script script has completed!" &_
	vblf & "SCRIPT NAME: OS_Engineering-HPSA_Install_WSUS_Patches_Step_1_script.vbs"
End If

WScript.Echo vbLf & "OS_Engineering-HPSA_Install_WSUS_Patches_Step_1_script script execution completed!"
